...
After the deploy is completed, you will see some outputs in the terminal displaying the S3 URL that you can open in your browser to view the static web page.
...
After the deploy is completed, you will see some outputs in the terminal displaying the S3 URL that you can open in your browser to view the static web page running on AWS.