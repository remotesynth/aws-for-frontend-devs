...
After the deploy is completed, you will see some outputs in the terminal displaying the CloudFront distribution URL that you can open in your browser to view the static web page.
...
After the deploy is completed, you will see some outputs in the terminal displaying the Cloudfront distribution URL that you can open in your browser to view the static web page cached at the edge via CloudFront.